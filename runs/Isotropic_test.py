...
if __name__ == "__main__":
    ...
    config.params.compute_energy = 64   # Compute energy every komlmogorv time scale
    config.params.compute_spectrum = 64 # Compute spectrum every komlmogorv time scale
